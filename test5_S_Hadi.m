...
F1=-9; 
d1 = 1; d2 = 1; d3 = 1;
dc1=0.5; dc2 = 0.5; dc3 = 0.5; dc4 = 0.5;
x03 = 0.2; xc3 = 0.2;
m1 = 1; m2 = 1; m3 = 1; m4 = 1;
I1 = 1; I2 = 1; I3 = 1; I4 = 1;
k2 = 1; k31 = 1; k32 = 1;
...
%inputs:
lc = [ 0 0 0 0 0 ;  0 0 -dc1 0 0 ; 0 0 -dc2 0 0 ; 0 -dc3 0 0 0 ; 0 x03-xc3 0 1 2 ];
m = [ m1 , m2 , m3 , m4];
I = sym ( zeros ( 3 , 3 , 4 ) );
...
j(1,:,2) = [ 0 0 0 0 -d1 ];
j(1,:,3) = [ 2 inf -d2 0 0 ];
j(1:2,:,4) = [ 3 inf 0 0 -d3 ; 1 inf 0 0 0 ];
% jkd = sym (zeros ( 3 , 2 , 9 ) );
jkd = sym (zeros ( 3 , 2 , 4 ) );
% jkd(2,:,4) = [ cv11 0 ]; jkd(2,:,5) = [ cv12 0 ]; jkd(2,:,6) = [ cv13 0 ];
% jkd(1:2,:,7) = [ k2 0; cv2 0 ]; jkd(1:2,:,8) = [ k31 0; cv31 0 ]; jkd(1:2,:,9) = [ k32 0; cv32 0 ];
jkd(3,:,1) = [ F1 -9 ]; jkd(1:2,:,2) = [ k2 0; cv2 0 ]; jkd(1:2,:,3) = [ k31 0; cv31 0 ]; jkd(1:2,:,4) = [ k32 0; cv32 0 ];
