...
%% EOM:
[ Mt , Tt , Ddt , fgt , fjt , rjt , rct , vct , wct , reft , rcnt ,  Teft , Tcnt , Dcnt , qft , uft ] = ...
    TMTEoM ( lc , m , I , j , jkd , g );

	
%% numerical simulation
[ t , z , tfinal ] = SimEoM5_S_v0_3Fun( Mt , Tt , Ddt , fgt , fjt , reft , Teft , qft , uft , 3e-2 );
plot ( t , z );
pause;


%% animation
AnimEOM( t , z , rjt , qft , uft );
